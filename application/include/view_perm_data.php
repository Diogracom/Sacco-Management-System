<div class="row">
            ...
            <div class="box-body">
             ...
             <div class="box-body">
<form method="post">
			 <a href="permission_list.php?id=<?php echo $_SESSION['tid']; ?>"><button type="button" class="btn btn-flat btn-warning"><i class="fa fa-mail-reply-all"></i>&nbsp;Back</button> </a> 
	<hr>	
...
<div class="box-body">
			...
			<div class="form-group">
				...
				<?php
					...
					{
					?>		
					<b style="color: red;"><?php echo $get_users['fname'].' '.$get_users['lname']; ?></b>
				<?php } ?>
                </div>			
            </div>
			<div class="form-group">
