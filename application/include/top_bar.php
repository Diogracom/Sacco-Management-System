              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    ...
                    <a href="profile.php?id=<?php echo $_SESSION['tid']; ?>" class="btn btn-primary btn-flat">Profile</a>
					          
                  </div>
                <a href="../logout.php" class="btn btn-warning btn-flat pull-right"><i class="fa fa-sign-out"></i>Sign out</a>
                </div>
                <!-- /.row -->
              </li>
              <!-- Menu Footer-->
