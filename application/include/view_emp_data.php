...
?>			 
			...
			<div class="form-group">
                  ...
                  <div class="col-sm-10">
                  <input name="name" type="text" class="form-control" value="<?php echo $rows['fname']; ?>" required>
                  </div>
                  </div>
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
                  	...
                  	<div class="col-sm-10">
					<textarea name="addr1"  class="form-control" rows="4" cols="80" required><?php echo $rows['addrs']; ?></textarea>
           			 </div>
          </div>
		...
		<div class="form-group">
                  <label for="" class="col-sm-2 control-label" style="color:#009900">Town</label>
                  <div class="col-sm-10">
		...
		<div class="form-group">
				...
				<select name="country"  class="form-control" required>
										...
										<option value="WO">Wakiso</option>
										<option value="MI">Mpigi</option>
										<option value="MO">Mukono</option>
										<option value="JA">Jinja</option>
										<option value="MA">Mityana</option>
									</select>                 
									 </div>
                 					 </div>
