...
<legend style="color: red;"><?php echo 'Share Transfer'; ?> Receipt</legend>
        </div>
...
?>	
         ...
         <div align="center" style="color: red;"><div><?php echo ($get_searched['image'] == "") ? 'No Stamp Yet...' : '<img src="../image/'.$get_searched['image'].'" width="150" height="100"/>'; ?></div><h4><strong>
         	<br>
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<th style="color: blue;"><?php echo strtoupper($fname1); ?> &nbsp; <?php echo strtoupper($lname1); ?></th>
				</tr>
				<tr>
				<td width="150">Transaction Purpose</td>
				<th style="color: blue;"><?php 

				 echo 'Transfered'.' '.$nshare.' '.'Share(s)'.' '.'to'.'&nbsp;'.$account2.' '.'From'.'&nbsp;'.$fname.' '.$lname; 
