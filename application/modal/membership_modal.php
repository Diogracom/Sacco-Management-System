...
<legend style="color: red;"><?php echo 'Membership Payment'; ?> Receipt</legend>
        </div>
...
?>	
			...
			<table id="example1" class="table table-bordered table-striped">
				...
				<th style="color: blue;"><?php echo strtoupper($fn); ?> &nbsp; <?php echo strtoupper($ln); ?></th>
				</tr>
				<tr>
				<td width="150">Transaction Purpose</td>
				<th style="color: blue;"><?php 

				 echo 'Payment'.' '.$get_searched['currency'].' '.number_format($amount,2,'.',',').'&nbsp;'.'for'.'&nbsp;'.$account; 
